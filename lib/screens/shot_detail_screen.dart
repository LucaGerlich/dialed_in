...
class ShotDetailScreen extends StatelessWidget {
  ...
  const ShotDetailScreen({super.key, required this.shot, required this.bean});
                      ...
                      children: [
                        if (shot.pressure != null)
                          _buildRowItem(
                            context,
                            l10n.pressure,
                            '${shot.pressure!.toStringAsFixed(1)} bar',
                          ),
                        if (shot.temperature != null)
                          _buildRowItem(
                            context,
                            l10n.temp,
                            '${shot.temperature!.toStringAsFixed(1)}°C',
                          ),
                        if (shot.preInfusionTime != null &&
                            shot.preInfusionTime! > 0)
                          _buildRowItem(
                            context,
                            l10n.preInfusion,
                            '${shot.preInfusionTime}s',
                          ),
                        if (shot.grinderRpm != null && shot.grinderRpm! > 0)
                          _buildRowItem(
                            context,
                            l10n.rpm,
                            shot.grinderRpm!.toStringAsFixed(0),
                          ),
                      ],
                    ),
                  ),
